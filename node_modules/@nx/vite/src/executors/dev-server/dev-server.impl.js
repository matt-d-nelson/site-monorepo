...
async function* viteDevServerExecutor(options, context) {
    ...
    }, 'serve', (_ref1 = (_otherOptions_mode1 = otherOptions == null ? void 0 : otherOptions.mode) != null ? _otherOptions_mode1 : buildTargetOptions == null ? void 0 : buildTargetOptions['mode']) != null ? _ref1 : 'development');
    var _resolved_root;
    // vite InlineConfig
