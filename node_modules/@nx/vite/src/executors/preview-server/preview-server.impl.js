...
async function* vitePreviewServerExecutor(options, context) {
    ...
    var _otherOptions_mode, _ref, _otherOptions_mode1, _ref1;
    ...
    }, 'build', (_ref1 = (_otherOptions_mode1 = otherOptions == null ? void 0 : otherOptions.mode) != null ? _otherOptions_mode1 : otherOptionsFromBuild == null ? void 0 : otherOptionsFromBuild.mode) != null ? _ref1 : 'production');
    var _options_staticFilePath, _ref2;
    const outDir = (_ref2 = (_options_staticFilePath = options.staticFilePath) != null ? _options_staticFilePath : (0, _devkit.joinPathFragments)((0, _devkit.offsetFromRoot)(projectRoot), buildTargetOptions.outputPath)) != null ? _ref2 : resolved == null ? void 0 : (_resolved_build = resolved.build) == null ? void 0 : _resolved_build.outDir;
    if (!outDir) {
