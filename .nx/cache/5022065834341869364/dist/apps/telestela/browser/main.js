...
// apps/telestela/src/app/app.routes.ts
var appRoutes = [
  {
    path: "",
    redirectTo: "/home",
  ...
  {
    path: "home",
    loadComponent: () => import("./chunk-QLXJIL3J.js").then((m) => m.TelestelaHomeComponent)
  }
];

// apps/telestela/src/app/app.config.ts
var appConfig = {
  providers: [
...
// apps/telestela/src/app/app.component.ts
var AppComponent = class _AppComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _AppComponent, selectors: [["app-root"]], standalone: true, features: [\u0275\u0275StandaloneFeature], decls: 2, vars: 0, template: function AppComponent_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275element(0, "shared-app-container")(1, "router-outlet");
    }
  }, dependencies: [RouterModule, RouterOutlet, AppContainerComponent] });
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(AppComponent, { className: "AppComponent" });
})();

// apps/telestela/src/main.ts
